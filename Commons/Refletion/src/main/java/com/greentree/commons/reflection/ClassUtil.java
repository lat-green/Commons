...
public final class ClassUtil {
	...
	protected static final ArrayList<CodeSource> sources;
	static {
	...
	protected static final Collection<Class<?>> classes = sources.stream().flatMap(x -> x.getAllClasses()).toList();
	
	protected static final Collection<String> packages;
	static {
