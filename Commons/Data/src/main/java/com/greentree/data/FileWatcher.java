...
import com.greentree.data.resource.ResourceActionImpl;
...
public class FileWatcher {
	...
	public static final class FolderResourceAction {
		...
		protected transient final EventAction<Path> onCreate = new EventAction<>();
		protected transient final EventAction<Path> onModify = new EventAction<>();
		protected transient final EventAction<Path> onDelete = new EventAction<>();
		
		protected transient final EventAction<Path> onCreateAbsolute = new EventAction<>();
		
		protected transient final EventAction<Path> onModifyAbsolute = new EventAction<>();
		
		protected transient final EventAction<Path> onDeleteAbsolute = new EventAction<>();
