...
public final class ResourceSupplier implements SourceProvider<Resource> {
	
	public static final int CHARACTERISTICS = BLANCK_CLOSE | NOT_NULL | EQUALS_ON_CHANGE;
	private long lastModified;
	private final Resource resource;
	
	
	public ResourceSupplier(Resource resource) {
