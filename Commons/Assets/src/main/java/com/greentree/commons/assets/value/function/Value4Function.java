...
public interface Value4Function<T1, T2, T3, T4, R> extends Value1Function<Group4<? extends T1, ? extends T2, ? extends T3, ? extends T4>, R> {
	...
	default boolean isNull(T1 value1, T2 value2, T3 value3, T4 value4) {
		return apply(value1, value2, value3, value4) == null;
	}
