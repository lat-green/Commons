...
public class PosYCubeMapTexture implements WriteTexture2D {
	public static final GLTexture2DEnumTarget GL_TEXTURE_CUBE_MAP_DIRECTION = TEXTURE_CUBE_MAP_POSITIVE_Y;

	public static final PosYCubeMapTexture INSTANCE = new PosYCubeMapTexture();


	private PosYCubeMapTexture() {
	}
