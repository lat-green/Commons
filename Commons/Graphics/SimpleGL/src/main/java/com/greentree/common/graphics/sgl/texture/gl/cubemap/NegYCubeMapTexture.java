...
public class NegYCubeMapTexture implements WriteTexture2D {
	public static final GLTexture2DEnumTarget GL_TEXTURE_CUBE_MAP_DIRECTION = TEXTURE_CUBE_MAP_NEGATIVE_Y;

	public static final NegYCubeMapTexture INSTANCE = new NegYCubeMapTexture();


	private NegYCubeMapTexture() {
	}
