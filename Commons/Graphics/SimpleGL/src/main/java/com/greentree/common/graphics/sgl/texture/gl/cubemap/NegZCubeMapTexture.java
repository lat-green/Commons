...
public class NegZCubeMapTexture implements WriteTexture2D {
	public static final GLTexture2DEnumTarget GL_TEXTURE_CUBE_MAP_DIRECTION = TEXTURE_CUBE_MAP_NEGATIVE_Z;

	public static final NegZCubeMapTexture INSTANCE = new NegZCubeMapTexture();


	private NegZCubeMapTexture() {
	}
