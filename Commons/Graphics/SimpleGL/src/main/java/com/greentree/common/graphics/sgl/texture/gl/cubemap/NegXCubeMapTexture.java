...
public class NegXCubeMapTexture implements WriteTexture2D {
	public static final GLTexture2DEnumTarget GL_TEXTURE_CUBE_MAP_DIRECTION = TEXTURE_CUBE_MAP_NEGATIVE_X;

	public static final NegXCubeMapTexture INSTANCE = new NegXCubeMapTexture();


	private NegXCubeMapTexture() {
	}
