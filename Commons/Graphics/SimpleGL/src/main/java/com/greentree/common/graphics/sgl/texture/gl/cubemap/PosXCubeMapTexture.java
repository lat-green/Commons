...
public class PosXCubeMapTexture implements WriteTexture2D {
	public static final GLTexture2DEnumTarget GL_TEXTURE_CUBE_MAP_DIRECTION = TEXTURE_CUBE_MAP_POSITIVE_X;

	public static final PosXCubeMapTexture INSTANCE = new PosXCubeMapTexture();


	private PosXCubeMapTexture() {
	}
