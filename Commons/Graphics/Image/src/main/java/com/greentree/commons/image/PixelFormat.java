...
public enum PixelFormat {
    ...
    public void write(Color color, ByteBuffer buffer) {
        var rgba = new byte[]{color.getRedByte(), color.getGreenByte(), color.getBlueByte(), color.getAlphaByte()};
        var result = PixelFormatConverter.convert(rgba, RGBA, this);
        buffer.put(result);
    }
}