...
public class UnOrentetPair<T> extends Pair<T, T> {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof UnOrentetPair other)) return false;
        if (first.equals(other.first)) return seconde.equals(other.seconde);
        else if (seconde.equals(other.seconde)) return first.equals(other.first);
        else if (first.equals(other.seconde)) return seconde.equals(other.first);
        else if (seconde.equals(other.first)) return first.equals(other.seconde);
        else
            return false;
    }
