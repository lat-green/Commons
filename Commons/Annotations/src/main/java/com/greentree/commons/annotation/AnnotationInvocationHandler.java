...
import static com.greentree.commons.util.UnsafeUtil.getUnsafeInstance;
...
public class AnnotationInvocationHandler implements InvocationHandler, Serializable {
    ...
    private void readObject(java.io.ObjectInputStream s)
        ...
        Map<String, Class<?>> memberTypes = memberTypes(t);
    ...
    private Map<String, Class<?>> memberTypes(Class<? extends Annotation> t) {
        var result = new HashMap<String, Class<?>>();
        for(var m : t.getDeclaredMethods())  {
            result.put(m.getName(), m.getReturnType());
        }
        return result;
    }
